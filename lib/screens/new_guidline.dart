...
setState(() {
                  ...
                  subtitle:Text(controller.listOfDosage[index].classification) ,
                  trailing:Text("${controller.listOfDosage[index].amount} ${controller.listOfDosage[index].suffix}")
                ),
              );
            }),
          ),
                              ...
                              child: DropdownButton2(
                                ...
                                hint: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        controller.dosageClassification.value.isEmpty
